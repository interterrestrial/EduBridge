    ...
    <DashboardLayout>
      <div className="max-w-7xl mx-auto space-y-8">
        <div>
          ...
          <p className="text-[#a0a0a0]">Track your exam readiness, subject attendance, and unlock study badges.</p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-card border border-border rounded-2xl p-6 shadow-sm">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="text-[#a0a0a0] font-medium">Exam Readiness</h3>
                </div>
              ...
              <div className="bg-card border border-border rounded-2xl p-6 shadow-sm">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="text-[#a0a0a0] font-medium">Subject Attendance</h3>
                </div>
              ...
              <div className="bg-card border border-border rounded-2xl p-6 shadow-sm">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="text-[#a0a0a0] font-medium">Total Study Hours</h3>
                </div>
              ...
              <div className="bg-card border border-border rounded-2xl p-6 shadow-sm">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="text-[#a0a0a0] font-medium">Quiz Accuracy</h3>
                </div>
            ...
            <div className="bg-card border border-border rounded-2xl p-6 space-y-4 shadow-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {(analytics?.badges || [
                  ...
                  <div key={badge.id} className="bg-input border border-amber-500/20 p-4 rounded-xl space-y-2 hover:border-amber-500/40 transition-colors">
                    <div className="text-3xl">{badge.icon}</div>
                    <h3 className="text-white font-bold text-base">{badge.title}</h3>
                    <p className="text-xs text-[#a0a0a0]">{badge.desc}</p>
                  </div>
                ))}
              </div>
            </div>
