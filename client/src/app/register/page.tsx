      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center p-8 relative">
        <div className="w-full max-w-[400px] flex flex-col items-center">
          ...
          <div className="flex items-center gap-3 mb-6 lg:hidden">
            <div className="w-12 h-12 bg-primary/20 rounded-2xl flex items-center justify-center shadow-md border border-primary/30">
              <GraduationCap className="w-7 h-7 text-primary" />
            </div>
            <span className="font-heading text-2xl font-bold text-white tracking-tight">EduBridge</span>
          </div>
          <h1 className="text-3xl font-medium text-white mb-2">Create Account</h1>
          <p className="text-[#a0a0a0] text-sm mb-10 text-center">Join EduBridge and transform your learning</p>
          
          <button 
            onClick={() => handleGoogleSignup()}
            type="button"
            className="w-full bg-white hover:bg-[#e6e6e6] text-black font-semibold py-3 px-4 rounded-xl flex items-center justify-center gap-3 transition-colors shadow-sm mb-6 cursor-pointer"
          >
          ...
          <form onSubmit={handleSubmit} className="w-full space-y-4">
            ...
            <div className="relative w-full">
               ...
               <select
                 ...
                 className="w-full bg-input border border-border rounded-lg text-foreground px-4 py-3 h-12 pl-11 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors appearance-none"
               >
